...
import com.doubleclick.multisearchview.databinding.ViewItemBinding
import com.doubleclick.multisearchview.databinding.ViewMultiSearchContainerBinding
import com.doubleclick.multisearchview.extensions.*
import com.doubleclick.multisearchview.helper.KeyboardHelper
import com.doubleclick.multisearchview.helper.KeyboardHelper.hideKeyboard
import com.doubleclick.multisearchview.helper.SimpleTextWatcher
...
class MultiSearchContainerView @JvmOverloads constructor(
    ...
    private val binding: ViewMultiSearchContainerBinding =
        inflate(R.layout.view_multi_search_container)
    ...
    private lateinit var multiSearchViewListener: MultiSearchViewListener
    ...
    fun completeSearch() {
        ...
        selectedTab?.let {
            ...
            val endWidthValue =
                it.root.editTextSearch.measuredWidth + sizeRemoveIcon + defaultPadding
